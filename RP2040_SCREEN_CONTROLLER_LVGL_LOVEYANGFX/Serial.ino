...
// Length checking is handled natively by the generic serial_parser_dispatch().
// ---------------------------------------------------------------------------
